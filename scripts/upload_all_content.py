...
PATCH_NOTES = [
    ...
    {
        "version": "1.0.7",
        "title": "Content Expansion & UI Polish 📚",
    ...
    {
        "version": "1.0.8",
        "title": "Thai Speakers Can Now Learn English! 🌏",
        "date": datetime(2026, 6, 26, tzinfo=timezone.utc),
        "type": "major",
        "notes": [
            "🌏 New: Learning English mode for Thai speakers — ฉันพูดภาษาไทย",
            "🇹🇭→🇬🇧 All 50 lessons now work in both learning directions",
            "🔤 Full UI switches to Thai when Learning English mode is active",
            "📖 Thai lesson titles added to all 28 Stage 1 lessons",
            "💾 Separate progress tracking per language — your stats never mix",
            "🔄 Language badge on home screen shows your current learning mode",
            "⚙️ Clear language toggle in Settings — no more confusing direction options",
            "✅ Confirmation dialog when switching languages",
            "🗺️ Lesson map shows Thai titles in English learning mode",
        ],
    },
]
